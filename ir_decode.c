...
int gpio_init()
{
    /*
     * wiringPiSetup()
     * uses wiringPi's own pin numbers. This assigns the usable 8 GPIO pins as numbers 0 through 7 and is invariant to the Pi hardware
     * revision. wiringPiSetupPhys() uses the P1 pin numbers 1 through 26. wiringPiSetupGpio () uses the broadcom chip gpio pin numbers.
     * Some of these do change between hardwar erevisions.
     */
